(function () {
    ...
    function setupEvents() {
		...
		//moves
         $(document).on('click', '.moves', function () {
                    $(this).animate({'padding-left':'+=10'}, 40, 'linear')
                        .animate({'padding-left':'-=20'}, 80, 'linear')
                        .animate({'padding-left':'+=10'}, 40, 'linear');
					console.log($(this).attr('data-id'));
                    sendRequest([{'action':'moves','name':$(this).attr('data-id')}]);
                });
    ...
    $(document).ready(function () {
        ...
        sendRequest([{'action':'sounds'},{'action':'screen'},{'action':'get'},{'action':'battery'},{'action':'volume'},{'action':'moves'}], function (data) {
